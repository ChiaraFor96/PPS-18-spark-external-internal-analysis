...
\lstinputlisting[language=Scala, firstline=15, lastline=18]{../src/main/scala/QuickStart.scala}
\section{Internals}
...
\newline 
Le stesse interrogazioni, senza il supporto dell'API SparkSQL, ma del solo SparkCore, sarebbero state sicuramente meno leggibili.%TODO rifai l'esempio senza sql
